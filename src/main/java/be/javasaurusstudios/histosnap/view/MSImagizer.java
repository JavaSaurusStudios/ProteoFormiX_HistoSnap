...
public class MSImagizer extends javax.swing.JFrame {
    ...
    protected static JList imageCacheList;
    ...
    public MSImagizer() {
        ...
        super.setIconImage(ButtonIcons.ICON.getIcon().getImage());
    ...
    public boolean iAnnotationMode() {
    ...
    private void initComponents() {
        ...
        jScrollPane4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Image", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 0, 11), new java.awt.Color(0, 0, 0))); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(logPanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 772, Short.MAX_VALUE)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void showRandomExtraction() {
        new RandomBackgroundExtractor(this, currentFilePath, lbImage).show(true);
    }
    ...
    private void btnLoadSessionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadSessionActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            progressFrame.setVisible(true);
            WorkingTask task = new SessionLoadingTask(progressFrame, yourFolder);
            new WorkingThread(this, task).execute();
        }
    ...
    private void showDHBExtraction() {
        new DHBBackgroundExtractionHandler(this, currentFilePath, lbImage).show(false);
    }
    ...
    private void initListeners() {
        ...
        new ScaleScrollListener(this, lbImage);
    }
    ...
    private void initToolbar() {
        ...
        //THE COLOR MODE
        JTextField selectColorField = new JTextField(3);
        selectColorField.setEditable(false);
        selectColorField.setFocusable(false);
        selectColorField.setPreferredSize(new Dimension(32, 16));
        selectColorField.setMaximumSize(new Dimension(32, 16));
        selectColorField.setMinimumSize(new Dimension(32, 16));
